declare namespace PIXI.spine.core {
  ...
  interface Timeline {
    apply(skeleton: Skeleton, lastTime: number, time: number, events: Event[], alpha: number, blend: MixBlend, direction: MixDirection): void;
  ...
  abstract class CurveTimeline implements Timeline {
    ...
    abstract apply(skeleton: Skeleton, lastTime: number, time: number, events: Event[], alpha: number, blend: MixBlend, direction: MixDirection): void;
  }
  ...
  class DeformTimeline extends CurveTimeline {
    ...
    frames: ArrayLike<number>;
    frameVertices: ArrayLike<number>[];
    constructor(frameCount: number);
    getPropertyId(): number;
    setFrame(frameIndex: number, time: number, vertices: ArrayLike<number>): void;
    apply(skeleton: Skeleton, lastTime: number, time: number, firedEvents: Event[], alpha: number, blend: MixBlend, direction: MixDirection): void;
  }
...
declare namespace PIXI.spine.core {
  class SkeletonClipping {
    ...
    clip(x1: number, y1: number, x2: number, y2: number, x3: number, y3: number, clippingArea: number[], output: number[]): boolean;
...
declare namespace PIXI.spine.core {
  ...
  class Skin {
    ...
    getAttachmentsForSlot(slotIndex: number, attachments: SkinEntry[]): void;
    clear(): void;
...
declare namespace PIXI.spine.core {
  class Triangulator {
    ...
    triangulate(verticesArray: ArrayLike<number>): number[];
    decompose(verticesArray: number[], triangles: number[]): number[][];
...
declare namespace PIXI.spine.core {
  ...
  class Utils {
    ...
    static contains<T>(array: T[], element: T, identity?: boolean): boolean;
  }
  class DebugUtils {
