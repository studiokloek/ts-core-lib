...
declare module 'pixi-spine' {
  ...
  import type { IAttachment, ISkeletonData, ISkin, ISlotData, TextureAtlas } from '@pixi-spine/base';
  import {
   ...
   * @public
   */
  export class AnimationStateData implements IAnimationStateData<SkeletonData, Animation_2> {
   ...
   * @public
   */
  class Event_2 implements IEvent {
    data: EventData;
    intValue: number;
    floatValue: number;
    stringValue: string;
  ...
  export class PathConstraint implements Updatable {
    ...
    addBeforePosition(p: number, temporary: Array<number>, index: number, out: Array<number>, o: number): void;
    addAfterPosition(p: number, temporary: Array<number>, index: number, out: Array<number>, o: number): void;
    addCurvePosition(
      p: number,
      x1: number,
      y1: number,
  ...
  export class Skeleton implements ISkeleton<SkeletonData, Bone, Slot, Skin> {
    ...
    getBounds(offset: Vector2, size: Vector2, temporary?: Array<number>): void;
    update(delta: number): void;
    get flipX(): boolean;
  ...
  export class SkeletonJson {
    ...
    getValue(map: any, property: string, defaultValue: any): any;
    static blendModeFromString(string_: string): BLEND_MODES.NORMAL | BLEND_MODES.ADD | BLEND_MODES.MULTIPLY | BLEND_MODES.SCREEN;
    static positionModeFromString(string_: string): PositionMode;
    static spacingModeFromString(string_: string): SpacingMode;
    static rotateModeFromString(string_: string): RotateMode;
    static transformModeFromString(string_: string): TransformMode;
  }
