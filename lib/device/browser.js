...
import { isApp } from '@studiokloek/kloek-ts-core/device';
...
export const browserSatisfies = (info) => {
...
export const deviceNeedsMediaTrigger = memoize(() => {
...
export const isObsoleteBrowser = () => {
    // app is altijd goed!
    if (isApp()) {
        return false;
    }
