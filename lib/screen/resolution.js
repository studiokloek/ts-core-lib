...
import { getPixelRatio, isMobile, isObsoleteBrowser, isPlatform, Platform } from '@studiokloek/kloek-ts-core/device';
...
export const determineResolution = memoize(() => {
    const pixelRatio = getPixelRatio(), viewportSize = Math.floor(getViewportSize() * pixelRatio);
    ...
    let screenResolution = ResolutionMode.NORMAL, textureResolution = ResolutionMode.NORMAL;
