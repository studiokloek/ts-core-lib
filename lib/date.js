...
export function isBetweenDates(start, end) {
...
export function getDateFromFirestoreString(value) {
    if (!value) {
        return;
    }
...
export function getDateFromAPIString(value) {
...
export function getSecondsBetween(d1, d2) {
    return Math.round((d1.getTime() - d2.getTime()) * 0.001);
}
export function calulateAgeFromDate(birthday) {
    if (!birthday) {
        return -1;
    }
